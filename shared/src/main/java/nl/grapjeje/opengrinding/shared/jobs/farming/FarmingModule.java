package nl.grapjeje.opengrinding.shared.jobs.farming;
...
import nl.grapjeje.opengrinding.shared.api.Plant;
import nl.grapjeje.opengrinding.shared.core.objects.CraftGrindingRegion;
import nl.grapjeje.opengrinding.shared.jobs.farming.configuration.FarmingJobConfiguration;
import nl.grapjeje.opengrinding.shared.jobs.farming.listeners.FarmingListener;
import nl.grapjeje.opengrinding.shared.jobs.farming.listeners.TrampleListener;
...
public class FarmingModule extends JobModule {
    ...
    public static ItemStack getBlockHead(nl.grapjeje.opengrinding.shared.jobs.farming.objects.Plant plant) {
